  ...
  return (
    <nav style={{
      ...
      <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', alignItems: 'center' }}>
        <Link to="/home" style={{ color: '#a0a0c0', textDecoration: 'none', fontSize: '0.9rem' }}>Browse Events</Link>
        <Link to="/create-event" style={{ color: '#a0a0c0', textDecoration: 'none', fontSize: '0.9rem' }}>Create Event</Link>
        <Link to="/login" style={{
